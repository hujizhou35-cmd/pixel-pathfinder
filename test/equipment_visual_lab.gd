...
##
##   Godot_v4.3-stable_win64.exe --headless --path . res://test/shot_test.tscn
##   Godot_v4.3-stable_win64.exe --headless --path . res://test/equipment_visual_lab.tscn

const HERO_W := 40
const HERO_FRAME_H := 52
const HERO_SHEET_H := 208
const OUTPUT_DIR := "res://test/shots_equipment_runtime"
...
const ACTUAL_UI_SOURCES := {
	"14_inventory_actual_ui.png": "res://test/shots/09b_bag_clothes_filter.png",
	"15_codex_actual_ui.png": "res://test/shots/10_codex_equip100.png",
	"16_combat_actual_runtime.png": "res://test/shots/05_combat_sword_plate.png",
}
